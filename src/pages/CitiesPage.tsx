    ...
    <div className="bg-black text-white min-h-screen">
      ...
      <div className="py-16">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-bold text-center text-[#9b87f5] mb-8">Service Locations</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="bg-gray-900 p-6 rounded-lg text-center">
              <h2 className="text-xl font-bold text-[#9b87f5] mb-4">Kochi</h2>
            ...
            <div className="bg-gray-900 p-6 rounded-lg text-center">
              <h2 className="text-xl font-bold text-[#9b87f5] mb-4">Trivandrum</h2>
              <p className="text-gray-300 mb-4">
            ...
            <div className="bg-gray-900 p-6 rounded-lg text-center">
              <h2 className="text-xl font-bold text-[#9b87f5] mb-4">Kozhikode</h2>
              <p className="text-gray-300 mb-4">
